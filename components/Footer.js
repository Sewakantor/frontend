                ...
                <div className="container mx-auto px-4 mb-12 md:mb-20">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full lg:w-1/3 px-4 mb-6 lg:mb-0">
                            ...
                            <div className="flex">
                                <a className="flex justify-center items-center w-10 h-10 mr-4 bg-red-50 rounded-full" href="#">
                                ...
                                <a className="flex justify-center items-center w-10 h-10 bg-red-50 rounded-full" href="#">
                            ...
                            <div className="flex flex-wrap justify-between -mx-4">
                                ...
                                <div className="w-1/2 lg:w-1/4 px-4">
                                    ...
                                    <ul className="text-sm">
                                        ...
                                        <li><a className="text-gray-500 hover:text-gray-600" href="#">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
